 ...
 */
abstract class BsDbleUnpaidSummaryMember extends AbstractEntity with CustomizeEntity with DBableEntity[UnpaidSummaryMember] with Serializable with Cloneable {
