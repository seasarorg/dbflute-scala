...
object MemberLoginDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected val _columnMemberLoginId: ColumnInfo = cci("MEMBER_LOGIN_ID", "MEMBER_LOGIN_ID", null, "会員ログインID", classOf[Long], "memberLoginId", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_54CEC946_F9BE_4522_9E7C_423C9A9874BB", false, null, null, null, null, null);
