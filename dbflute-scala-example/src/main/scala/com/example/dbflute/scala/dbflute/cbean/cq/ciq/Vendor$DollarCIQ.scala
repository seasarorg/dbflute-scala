 ...
 */
class Vendor$DollarCIQ(childQuery: ConditionQuery, sqlClause: SqlClause, aliasName: String, nestLevel: Integer, myCQ: BsVendor$DollarCQ)
        extends AbstractBsVendor$DollarCQ(childQuery, sqlClause, aliasName, nestLevel) {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected var _myCQ: BsVendor$DollarCQ = null;
    ...
    //                                                                ====================
    protected def getCValueVendor$DollarId(): ConditionValue = { return _myCQ.getVendor$DollarId(); }
    protected def getCValueVendor$DollarName(): ConditionValue = { return _myCQ.getVendor$DollarName(); }
    ...
    protected def xinCB(): String = { return classOf[Vendor$DollarCB].getName(); }
    protected def xinCQ(): String = { return classOf[Vendor$DollarCQ].getName(); }
}
