 ...
 */
abstract class BsMbleMemberStatus extends Entity with Serializable with Cloneable with DfCoupleProperties {
    ...
    protected var _memberList: scala.collection.immutable.List[MbleMember] = null;
     ...
     */
    def memberList(memberList: scala.collection.immutable.List[MbleMember]): Unit = {
    ...
    def toImmutable(): MemberStatus = {
        return new MemberStatus(this.asInstanceOf[MbleMemberStatus]);
    }
    ...
    override def equals(obj: Any) = {
        obj match {
            case obj: BsMbleMemberStatus => {
                val other: BsMbleMemberStatus = obj.asInstanceOf[BsMbleMemberStatus];
                {
