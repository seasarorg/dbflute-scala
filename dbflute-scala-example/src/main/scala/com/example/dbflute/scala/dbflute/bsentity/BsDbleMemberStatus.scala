 ...
 */
abstract class BsDbleMemberStatus extends Entity with DBableEntity[MemberStatus] with Serializable with Cloneable with DerivedMappable {
     ...
     */
    def toImmutableMemberList(): scala.collection.immutable.List[Member] = {
