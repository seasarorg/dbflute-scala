 ...
 */
abstract class BsDbleMemberAddress extends AbstractEntity with DomainEntity with EntityDefinedCommonColumn with DBableEntity[MemberAddress] with Serializable with Cloneable {
