 ...
 */
abstract class BsDbleMemberAddress extends EntityDefinedCommonColumn with DBableEntity[MemberAddress] with Serializable with Cloneable with DerivedMappable {
