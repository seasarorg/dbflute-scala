 ...
 */
class SummaryProductCIQ(childQuery: ConditionQuery, sqlClause: SqlClause, aliasName: String, nestLevel: Integer, myCQ: BsSummaryProductCQ)
        extends AbstractBsSummaryProductCQ(childQuery, sqlClause, aliasName, nestLevel) {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected var _myCQ: BsSummaryProductCQ = null;
    ...
    protected def getCValueLatestPurchaseDatetime(): ConditionValue = { return _myCQ.getLatestPurchaseDatetime(); }
    ...
    protected def xinCB(): String = { return classOf[SummaryProductCB].getName(); }
    protected def xinCQ(): String = { return classOf[SummaryProductCQ].getName(); }
}
