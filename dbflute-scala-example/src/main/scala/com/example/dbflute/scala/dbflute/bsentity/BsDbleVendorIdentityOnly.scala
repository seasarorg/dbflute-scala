 ...
 */
abstract class BsDbleVendorIdentityOnly extends AbstractEntity with DomainEntity with DBableEntity[VendorIdentityOnly] with Serializable with Cloneable {
