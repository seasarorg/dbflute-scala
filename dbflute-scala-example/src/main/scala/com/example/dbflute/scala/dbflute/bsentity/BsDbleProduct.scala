 ...
 */
abstract class BsDbleProduct extends AbstractEntity with DomainEntity with EntityDefinedCommonColumn with DBableEntity[Product] with Serializable with Cloneable {
