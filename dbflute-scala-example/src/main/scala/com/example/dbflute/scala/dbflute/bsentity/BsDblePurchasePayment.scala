 ...
 */
abstract class BsDblePurchasePayment extends AbstractEntity with DomainEntity with EntityDefinedCommonColumn with DBableEntity[PurchasePayment] with Serializable with Cloneable {
