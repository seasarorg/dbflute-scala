 ...
 */
abstract class BsDbleVendorTheLongAndWindingTableAndColumn extends AbstractEntity with DomainEntity with DBableEntity[VendorTheLongAndWindingTableAndColumn] with Serializable with Cloneable {
