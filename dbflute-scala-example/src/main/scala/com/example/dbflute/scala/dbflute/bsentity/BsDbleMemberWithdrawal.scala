 ...
 */
abstract class BsDbleMemberWithdrawal extends EntityDefinedCommonColumn with DBableEntity[MemberWithdrawal] with Serializable with Cloneable with DerivedMappable {
