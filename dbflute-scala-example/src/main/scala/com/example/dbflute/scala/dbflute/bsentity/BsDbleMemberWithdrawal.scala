 ...
 */
abstract class BsDbleMemberWithdrawal extends AbstractEntity with DomainEntity with EntityDefinedCommonColumn with DBableEntity[MemberWithdrawal] with Serializable with Cloneable {
