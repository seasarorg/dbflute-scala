 ...
 */
abstract class BsDbleMember extends AbstractEntity with DomainEntity with EntityDefinedCommonColumn with DBableEntity[Member] with Serializable with Cloneable {
