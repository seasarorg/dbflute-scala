 ...
 */
abstract class BsDbleVendorTheLongAndWindingTableAndColumnRef extends AbstractEntity with DomainEntity with DBableEntity[VendorTheLongAndWindingTableAndColumnRef] with Serializable with Cloneable {
