 ...
 */
abstract class BsDbleMemberService extends AbstractEntity with DomainEntity with EntityDefinedCommonColumn with DBableEntity[MemberService] with Serializable with Cloneable {
